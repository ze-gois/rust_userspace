...
ample::trait_place_bytes!();

impl<T> crate::traits::Allocatable<ample::Origin, ample::Origin> for T
where
    T: crate::traits::Bytes<ample::Origin, ample::Origin>,
{
    unsafe fn allocate(layout: ample::traits::allocatable::Layout) -> *mut u8 {
        let n = layout.size * <T as crate::traits::Bytes<ample::Origin, ample::Origin>>::BYTES_SIZE;
    ...
    unsafe fn deallocate(ptr: *mut u8, layout: ample::traits::allocatable::Layout) {
        let total_size =
            layout.size * <T as crate::traits::Bytes<ample::Origin, ample::Origin>>::BYTES_SIZE;
