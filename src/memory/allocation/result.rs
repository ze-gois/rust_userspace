ample::result!(
    ...
    [
        ...
        [2; USERSPACE_MEMORY_ALLOCATE_HEAP_OK; Allocate; crate::memory::allocation::heap::Ok; "ZE"; "Entry to ze"],
    ];
    Error;
    "Allocate Ok";
    usize;
    [
        ...
        [2; USERSPACE_MEMORY_ALLOCATE_HEAP_ERROR; Allocate; crate::memory::allocation::heap::Error; "ZE"; "Entry to ze"],
    ]
);
