...
pub mod ok {
    ample::result!(
        ...
        usize;
        [
            [0; SYSCALL0_OK; Default; usize; "ZE"; "Entry to ze"],
        ]
    );
...
pub mod error {
    ample::result!(
        ...
        usize;
        [
            [0; SYSCALL0_ERROR; Default; usize; "ZE"; "Entry to ze"],
        ]
    );
    ...
    if (result as isize) < 0 {
        core::result::Result::Err(crate::Error::Target(crate::target::Error::Architecture(
            crate::target::architecture::Error::Syscall(
                crate::target::architecture::x86::bit64::syscall::Error::Syscall0(Error::Default(result)),
            ),
        )))
    } else {
        core::result::Result::Ok(crate::Ok::Target(crate::target::Ok::Architecture(
            crate::target::architecture::Ok::Syscall(
                crate::target::architecture::x86::bit64::syscall::Ok::Syscall0(Ok::Default(result)),
            ),
        )))
    }
}
