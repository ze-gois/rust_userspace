...
macro_rules! publish_types {
    ($class:ident, $class_ident:ident, [$([$ident_vis:vis $ident:ident, $ident_type:ty]),* $(,)?]) => {
        ...
        $crate::trait_implement_primitive!(false, $($ident),*);
        $crate::trait_implement_bytes!($($ident),*);
        $(
            impl $ident {
                pub fn read(fd: isize, endianness: bool) -> $crate::Result
                where
                    [u8; <$ident as $crate::traits::Bytes<$crate::Origin, $crate::Origin>>::BYTES_SIZE]:,
                {
                    let mut bytes = [0u8; <$ident as $crate::traits::Bytes<$crate::Origin, $crate::Origin>>::BYTES_SIZE];

                    match $crate::target::os::syscall::read(fd, bytes.as_mut_ptr(), <$ident as $crate::traits::Bytes<$crate::Origin, $crate::Origin>>::BYTES_SIZE) {
                        core::result::Result::Ok($crate::Ok::Target($crate::target::Ok::Os($crate::target::os::Ok::Syscall($crate::target::os::syscall::Ok::Write($crate::target::os::syscall::write::Ok::Default(value)))))) => {
                            if value != <$ident as $crate::traits::Bytes<$crate::Origin, $crate::Origin>>::BYTES_SIZE {
                            ...
                            let value = $ident(match endianness {
                                true => <$ident as $crate::traits::Bytes<$crate::Origin, $crate::Origin>>::from_bytes(bytes,true).into(),
                                false => <$ident as $crate::traits::Bytes<$crate::Origin, $crate::Origin>>::from_bytes(bytes,false).into(),
                            });
